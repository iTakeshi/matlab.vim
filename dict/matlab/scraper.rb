...
exclusions = ['break', 'colon', 'continue', 'end', 'false', 'for', 'function', 'function_handle', 'i', 'if/elseif/else', 'Inf', 'is*', 'j', 'LogicalOperators: Elementwise', 'LogicalOperators: Short-circuit', 'NaN', 'parfor', 'pause', 'pi', 'rat, rats', 'RelationalOperators', 'return', 'Special Characters', 'switch/case/otherwise', 'true', 'try/catch', 'while']
